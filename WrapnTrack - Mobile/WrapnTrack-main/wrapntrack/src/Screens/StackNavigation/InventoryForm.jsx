                    ...
                    <View style={{width: '100%'}}>
                        ...
                        <View style={{width: '100%', alignItems: 'center'}}>
                            ...
                            <View style={{ width: '100%', marginTop: 20, flexDirection: 'row', justifyContent: 'space-between' }}>
                                {[...Array(5)].map((_, index) => (
                                <View key={index} style={{ width: 50, height: 50, backgroundColor: '#D9D9D9' }}></View>
                                ))}
                            </View>
                            <TextInputForm label={'Item Name'}/>
                            <TextInputForm label={'Variant'}/>        
                            <SelectInput label={'Category'}/>
                            <ButtonTextInput label={'SKU (Stock Keeping Unit)'} icon={'barcode'}/>
                    ...
                    <View style={{borderTopWidth: 1, borderTopColor: '#888888', width: '100%', marginTop: 30, paddingTop: 20}}>
                        ...
                        <View style={{width: '100%', alignItems: 'center'}}>
                            ...
                            <View style={{flexDirection: 'row', width: '100%', justifyContent: 'space-between', marginTop: 20}}>
                                <View  style={{width: '45%'}}>
                                    <Text style={{ fontSize: 14, fontWeight: 500, marginBottom: 5}}>Weight / Volume</Text>
                                    <View style={{borderWidth: 1, borderColor: '#ccc', borderRadius: 5}}>
                                        <TextInput style={{ height: 50, borderRadius: 6, paddingHorizontal: 10, width: '100%' }}/>
                                    </View>
                                </View>
                                <View style={{width: '45%'}}>
                                    <Text style={{ fontSize: 14, fontWeight: 500, marginBottom: 5 }}>Unit</Text>
