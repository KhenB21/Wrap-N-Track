  ...
  return (
    <TouchableOpacity style={{ height: 100, width: '100%', flexDirection: 'row', alignItems: 'center', marginVertical: 10 }}>
        ...
        <View style={{ height: 80, marginLeft: 20 }}>
            <Text style={{ fontWeight: 'bold', fontSize: 14, marginBottom: 10, color: themeStyles.textColor }}>{reportTitle}</Text>
            <Text style={{fontSize: 14, color: themeStyles.textColor, width: 235 }}>{description}</Text>
        </View>
    </TouchableOpacity>
  )
}
