...
const InventoryItemDetails = ({ route }) => {
  ...
  return (
    <View>
      <ScrollView
        contentContainerStyle={{ alignItems: 'center', paddingBottom: 10, backgroundColor: themeStyles.backgroundColor }}
      ...
      >
        ...
        >
          {/* Main Image */}
          <Image
            source={{ uri: focused || 'https://via.placeholder.com/350' }}
            style={{
              width: '100%',
              height: 350,
          ...
          <View style={{ width: '100%', padding: 15 }}>
            ...
            <View style={{ borderTopWidth: 1, borderTopColor: '#888888', width: '100%', paddingTop: 20 }}>
              <Text style={{ fontSize: 16, fontWeight: 'bold', color: themeStyles.textColor }}>General Information</Text>
            ...
            >
              <Text style={{ fontSize: 16, fontWeight: 'bold', color: themeStyles.textColor }}>Inventory & Availability</Text>
              <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                <View>
            ...
            >
              <Text style={{ fontSize: 16, fontWeight: 'bold', color: themeStyles.textColor }}>Pricing Information</Text>
              <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                <View>
                  <Text style={{ color: themeStyles.textColor, fontSize: 14, marginTop: 20 }}>Price</Text>
                </View>
                <View>
                  <Text style={{ color: themeStyles.textColor, fontSize: 18, textAlign: 'right', marginTop: 20, fontWeight: 'bold' }}>
                    ₱{item.price || 'N/A'}
                  </Text>
                </View>
              </View>
