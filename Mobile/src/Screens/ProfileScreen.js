    ...
    <View style={{ flex: 1, backgroundColor: colors.bg }}>
      ...
      <ScrollView keyboardShouldPersistTaps="handled">
        ...
        <View style={[styles.card, { backgroundColor: colors.card }]}>
          ...
          <TextInput style={[styles.input, { backgroundColor: colors.input, color: colors.text, borderColor: colors.border }]} value={username} onChangeText={setUsername} />
          ...
          <View style={[styles.phoneRow, { backgroundColor: colors.input, borderColor: colors.border }]}>
            ...
            <TextInput style={[styles.phoneInput, { color: colors.text }]} value={phoneDigits} onChangeText={(v) => setPhoneDigits(v.replace(/\D/g, "").slice(0, 10))} keyboardType="number-pad" maxLength={10} placeholder="9123456789" />
          </View>
          ...
          <TextInput style={[styles.input, { backgroundColor: colors.input, color: colors.text, borderColor: colors.border }]} value={houseStreetNumber} onChangeText={setHouseStreetNumber} placeholder="House No., Block/Lot, Street" />
          ...
          <TextInput style={[styles.input, { backgroundColor: colors.input, color: colors.text, borderColor: colors.border }]} value={postal} onChangeText={(v) => setPostal(v.replace(/\D/g, "").slice(0, 4))} keyboardType="number-pad" maxLength={4} placeholder="4-digit postal code" />
