...
const DashboardScreen = ({route}) => {
    ...
    return (
        <View style={{flex: 1, alignItems: 'center', paddingBottom: 165}}>
            <View style={{width: '100%', paddingHorizontal: 10, alignItems: 'center', height: 170, backgroundColor: themeStyles.headerColor}}>
            ...
            <View style={{width: '100%', alignItems: 'center', backgroundColor: themeStyles.backgroundColor }}>
                ...
                >
                    ...
                    {/* Inventory Overview */}
                    <View style={{width: '100%', padding: 10, borderRadius: 10, backgroundColor: themeStyles.containerColor, marginBottom: 10}}>

                        {/* Title */}
                        <Text style={{fontWeight: 'bold', fontSize: 16, marginBottom: 20, color: themeStyles.textColor}}>Inventory Overview</Text>
                        ...
                        <View style={{flexDirection: 'row', width: '100%', marginBottom: 16}}>
                            <View style={{flexDirection: 'row', width: '50%'}}>
                                ...
                                <View style={{justifyContent: 'space-between', marginLeft: 10}}>
                                    <Text style={{fontWeight: 400, color: themeStyles.textColor}}>Total Products</Text>
                                    <Text style={{fontWeight: 500, fontSize: 18, color: themeStyles.textColor}}>423</Text>
                                </View>                
                            </View> 
                            <View style={{flexDirection: 'row', width: '50%'}}>
                                <View style={{height: 50, width: 5, backgroundColor: '#36AE7C', borderRadius: 5}}/>
                                <View style={{justifyContent: 'space-between', marginLeft: 10}}>                                   
                                    <Text style={{fontWeight: 400, color: themeStyles.textColor}}>Total Product Units</Text>
                                    <Text style={{fontWeight: 500, fontSize: 18, color: themeStyles.textColor}}>15,031</Text>
                                </View>                
                            </View> 
                        </View> 
                        <View style={{flexDirection: 'row', width: '100%'}}>
                            <View style={{flexDirection: 'row', width: '50%'}}>
                                ...
                                <View style={{justifyContent: 'space-between', marginLeft: 10}}>                                  
                                    <Text style={{fontWeight: 400, color: themeStyles.textColor}}>Replenishment</Text>
                                    <Text style={{fontWeight: 500, fontSize: 18, color: themeStyles.textColor}}>47</Text>
                                </View>                
                            </View> 
                            <View style={{flexDirection: 'row', width: '50%'}}>
                                ...
                                <View style={{justifyContent: 'space-between', marginLeft: 10}}>                                   
                                    ...
                                    <Text style={{fontWeight: 500, fontSize: 18, color: themeStyles.textColor}}>207</Text>
                                </View>                
                            </View> 
                        </View>                 
                    </View>
                    ...
                    <View style={{width: '100%', padding: 10, borderRadius: 10, backgroundColor: themeStyles.containerColor, marginBottom: 10}}>
                        ...
                        {/* Title */}
                        <Text style={{fontWeight: 'bold', fontSize: 16, color: themeStyles.textColor}}>Sales Overview</Text>
                        <Text style={{fontWeight: 500, fontSize: 12, color: '#888888', marginBottom: 20, color: themeStyles.textColor}}>February</Text>
                        ...
                        <View style={{flexDirection: 'row', width: '100%', marginBottom: 16}}>
                            ...
                            <View style={{flexDirection: 'row', width: '50%'}}>
                                ...
                                <View style={{justifyContent: 'space-between', marginLeft: 10}}>
                                    <Text style={{fontWeight: 400, color: themeStyles.textColor}}>Total Revenue</Text>
                                    <Text style={{fontWeight: 500, fontSize: 18, color: themeStyles.textColor}}>423</Text>
                                </View>                
                            </View> 
                            <View style={{flexDirection: 'row', width: '50%'}}>
                                ...
                                <View style={{justifyContent: 'space-between', marginLeft: 10}}>
                                    <Text style={{fontWeight: 400, color: themeStyles.textColor}}>Total Orders</Text>
                                    <Text style={{fontWeight: 500, fontSize: 18, color: themeStyles.textColor}}>15,031</Text>
                                </View>                
                            </View> 
                        </View> 
                        <View style={{flexDirection: 'row', width: '100%'}}>
                            <View style={{flexDirection: 'row', width: '50%'}}>
                                ...
                                <View style={{justifyContent: 'space-between', marginLeft: 10}}>
                                    <Text style={{fontWeight: 400, color: themeStyles.textColor}}>Total Units Sold</Text>
                                    <Text style={{fontWeight: 500, fontSize: 18, color: themeStyles.textColor}}>423</Text>
                                </View>                
                            </View> 
                            <View style={{flexDirection: 'row', width: '50%'}}>
                                ...
                                <View style={{justifyContent: 'space-between', marginLeft: 10}}>
                                    <Text style={{fontWeight: 400, color: themeStyles.textColor}}>Total Customers</Text>
                                    <Text style={{fontWeight: 500, fontSize: 18, color: themeStyles.textColor}}>207</Text>
                                </View>                
                            </View> 
                        </View>                 
                    </View>
                    <View style={{width: '100%', padding: 10, borderRadius: 10, backgroundColor: themeStyles.containerColor}}>

                        {/* Sales Activity */}
                        <Text style={{fontWeight: 'bold', fontSize: 16, marginBottom: 20, color: themeStyles.textColor}}>Sales Overview</Text>
