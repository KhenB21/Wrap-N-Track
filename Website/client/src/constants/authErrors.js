// Turns a failed login/register request into a message a person can act on.
...
// Keep in sync with Mobile/src/constants/authErrors.js.
...
// Which form field the server blamed ('name' | 'email' | 'username' | 'password' | 'role').
