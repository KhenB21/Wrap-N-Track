        ...
        <div className="user-management-container">
          ...
          {users.length === 0 ? (
            <div className="no-users-message">
              No users found. Click "Register Account" to add a new user.
            </div>
          ) : (
          ...
          <div className="user-modal-overlay" onClick={handleModalClose}>
            <div className="user-modal" onClick={(e) => e.stopPropagation()}>
              <div className="user-modal-header">
                <h3>Edit User</h3>
                <button className="user-modal-close" onClick={handleModalClose}>
                  &times;
                </button>
              </div>
              <div className="user-modal-body">
                <img
                  src={
                    selectedUser.profile_picture_data
                      ? `data:image/jpeg;base64,${selectedUser.profile_picture_data}`
                      : "/placeholder-profile.png"
                  }
                  alt="Profile"
                ...
                <div className="user-modal-fields">
                  <label>
                    User ID: <span>{selectedUser.user_id}</span>
                  </label>
                  <label>
                    Name:{" "}
                    <input
              ...
              <div className="user-modal-actions">
                ...
                <button className="user-modal-delete" onClick={handleDelete}>
                  Delete
                </button>
              </div>
            </div>
